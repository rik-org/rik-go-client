...
type InstanceSpecFunction struct {
	Execution *InstanceSpecFunctionExecution `json:"execution,omitempty"`
	Exposure *InstanceSpecFunctionExposure `json:"exposure,omitempty"`
}
...
func (o *InstanceSpecFunction) GetExecution() InstanceSpecFunctionExecution {
	if o == nil || IsNil(o.Execution) {
		var ret InstanceSpecFunctionExecution
		return ret
	}
	return *o.Execution
}
...
// SetExecution gets a reference to the given InstanceSpecFunctionExecution and assigns it to the Execution field.
...
func (o *InstanceSpecFunction) GetExposure() InstanceSpecFunctionExposure {
	if o == nil || IsNil(o.Exposure) {
		var ret InstanceSpecFunctionExposure
		return ret
	}
	return *o.Exposure
}
...
// SetExposure gets a reference to the given InstanceSpecFunctionExposure and assigns it to the Exposure field.
