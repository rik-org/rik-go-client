...
type WorkloadSpec struct {
	Function *FunctionWorkload `json:"function,omitempty"`
...
// SetFunction gets a reference to the given FunctionWorkload and assigns it to the Function field.
